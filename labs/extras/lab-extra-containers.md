...
$Volume = New-AzContainerInstanceVolume `
  -Name "logs" `
  -AzureFileShareName $ShareName `
  -AzureFileStorageAccountCredential $Credential
...
### 3.2 Criar Container App (CLI e PowerShell)
...
### 3.3 Diferenca ACI vs Container Apps vs AKS
...
### 4.4 Build de imagem no ACR (sem Docker local)
