...
# TASK 1.5 - Criar grupo dinamico (requer Entra ID P1/P2)
# ============================================================
# CONCEITO: Bicep NAO pode criar grupos do Entra ID.
# Bicep gerencia recursos Azure Resource Manager, mas grupos sao
# objetos de diretorio gerenciados via Microsoft Graph API.
# Alternativas: az CLI ou Microsoft Graph REST API.

# Criar grupo e configurar dynamic membership via Graph API
az ad group create \
...
# Configurar regra dinamica via Graph API
az rest --method PATCH \
